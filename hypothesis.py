...
# Deprecated. h_spaces are now generated dynamically.
class Hypothesis:
    ...
    def __init__(self, morphology, hyp_increment=3):  # TODO(RJR) 3 -> None
        ...
        for h_set in morphology.mnb:
            ...
            h_space = generate_hyp_space(list_of_endings, hyp_increment)
...
def generate_hyp_space(list_of_items, increment_divisor=None):
